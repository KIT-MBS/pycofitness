from pyfitness.logging_config.logging_config import LOGGING_CONFIG
from pyfitness.logging_config.logging_config import ConsoleColor as c_color
from pyfitness.mutation import mutation
from pyfitness.mutation import mutation 
...
class CmdArgs:
    """Defines command line argument variables for plmDCA and pyfitness.
    """
    msa_file = 'msa_file'
