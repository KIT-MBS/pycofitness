...
from pyfitness.fasta_reader.fasta_reader import get_alignment_from_fasta_file
from pyfitness.resmapping.resmapping import residue_mapping
from logging import config
from  pyfitness.plmdca.plmdca import PlmDCA
from pyfitness.msa_trimmer.msa_trimmer import MSATrimmer
import logging 
...
if __name__ == '__main__':
    from pyfitness.logging_config.logging_config import configure_logging
    configure_logging()
    main()